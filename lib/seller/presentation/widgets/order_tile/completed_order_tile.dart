...
class CompletedOrderTileWidget extends StatelessWidget {
  final OrderDataModel orderDataModel;
  late OrderPageBloc orderPageBloc;
  CompletedOrderTileWidget({super.key, required this.orderDataModel});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        orderPageBloc.add(OrderPageCompletedOrderTileClickedEvent(

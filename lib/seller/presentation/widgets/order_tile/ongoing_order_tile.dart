...
class OngoingOrderTileWidget extends StatelessWidget {
  final OrderDataModel orderDataModel;
  late OrderPageBloc orderPageBloc;
  OngoingOrderTileWidget({super.key, required this.orderDataModel});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        orderPageBloc.add(OrderPageOngoingOrderTileClickedEvent(

...
import '../../widgets/post_tile/post_tile_widget_horizontal.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    homePageBloc.add(HomePageInitialFetchEvent());
    super.initState();
  }
    ...
    return BlocConsumer<HomePageBloc, HomePageState>(
      ...
      builder: (context, state) {
        switch (state.runtimeType) {
          ...
          case HomePageLoadingSucsessState:
            final sucessState = state as HomePageLoadingSucsessState;
            return Scaffold(
